...
export default function ClientPage({
  ...
  return (
    <div>
      ...
      <div>
        <div>현재 {responseBody.currentPageNumber}페이지 입니다.</div>

        <div>페이지당 {responseBody.pageSize}개의 글이 조회됩니다.</div>

        <div>총 페이지 수는 {responseBody.totalPages}페이지 입니다.</div>

        <div>총 글 갯수는 {responseBody.totalItems}개 입니다.</div>
      </div>
